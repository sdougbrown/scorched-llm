...
import type { AgentTurnResult, TankAgent, ToolExecutor, ToolSpec } from '@scorched-llm/engine'
import { DIRECTION_DELTAS, euclidean, inBounds } from '@scorched-llm/engine'
