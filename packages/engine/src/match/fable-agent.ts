...
import type { TankAgent, AgentMessage, ToolSpec, ToolExecutor, AgentTurnResult } from './fake-agents.js'
import type { Coordinate, Direction, TerrainKind } from '../types/coords.js'
import type { MatchConfig } from '../config/schema.js'
import { euclidean, chebyshev, DIRECTION_DELTAS, inBounds } from '../geometry/coords.js'
